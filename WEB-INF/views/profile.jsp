...
<body style="background: url(static/images/bg+1.jpg) no-repeat center fixed; background-size: cover;">
<!-- HEADER -->
...
<div class="card card-cascade mt-5">
  ...
  <div class="view view-cascade overlay">
    <span class="rounded-circle"><img class="card-img-top rounded-circle" src="static/images/bg+8.jpg" alt="Card image cap"></span>
    <a>
...
<!-- Card Regular -->
  ...
  <div class="row">
    ...
    <div class="col-sm-8"><a href="tracksheet#input/" ><span class="text-success" style="text-decoration: underline; font-size: 50px;">WORKOUT LOG</span></a></div>
  </div>
  </div>
