...
<!-- <body class="tsbg"> -->
<body style="background: url(static/images/bg+10.jpg) no-repeat center fixed; background-size: cover;">
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item" role="presentation">
    <a class="nav-link ${active}" id="tsd-tab" data-toggle="tab" href="#tsd" role="tab" aria-controls="tsd" aria-selected="true"><span class="tsnavhead purple-text">WORKOUT LOG</span></a>
  </li>
  <li class="nav-item" role="presentation">
    <a class="nav-link ${activeInput}" id="input-tab" data-toggle="tab" href="#input" role="tab" aria-controls="input" aria-selected="false"><span class="tsnavhead purple-text">BARBELL</span></a>
  </li>
  <li class="nav-item" role="presentation">
    <a class="nav-link ${activemonout}" id="monout-tab" data-toggle="tab" href="#monout" role="tab" aria-controls="monout" aria-selected="false"><span class="tsnavhead purple-text">DUMBBELL</span></a>
  </li>
  <li class="nav-item" role="presentation">
    <a class="nav-link ${activefohout}" id="fohout-tab" data-toggle="tab" href="#fohout" role="tab" aria-controls="fohout" aria-selected="false"><span class="tsnavhead purple-text">MACHINE</span></a>
  </li>
   <li class="nav-item" role="presentation">
    <a class="nav-link ${activewi}" id="wt-tab" data-toggle="tab" href="#wt" role="tab" aria-controls="wt" aria-selected="false"><span class="tsnavhead purple-text">CARDIO</span></a>
  </li>
   <li class="nav-item" role="presentation">
    <a class="nav-link ${activewo}" id="wr-tab" data-toggle="tab" href="#wr" role="tab" aria-controls="wr" aria-selected="false"><span class="tsnavhead purple-text">OTHER</span></a>
  </li>
  <li>
  <div><a class="navbarButton5" style="color: #ffffff;" href="newsheet">NEW WORKOUTLOG</a></div>
  </li>
   <li>
  <!-- <div class="dropdown">
...
<div class="card blue-grey darken-4">
  <h3 class="card-header text-center font-weight-bold text-uppercase py-4"><span class="navbarMain white-text">LOG DETAILS</span></h3>
...
<%--     <form:form action="tssubmit" method="post" modelAttribute="tracksheet"> --%>
      <table name="tsd" class="table table-bordered table-responsive-md table-striped text-center">
        <thead>
          <tr class="blue-grey darken-1 mdb-color white-text">
...
<div class="tab-pane fade ${activeInputShow}" id="input" role="tabpanel" aria-labelledby="input-tab">  
 <!--  Editable table -->
<div class="card blue-grey darken-4">
  <h3 class="card-header text-center font-weight-bold text-uppercase py-4 white-text">ADD EXERCISES</h3>
    <div class="card-body blue-grey lighten-5">
      ...
      <table name="inputs" class="table table-bordered table-responsive-md table-striped text-center">
        <thead>
          <tr class="blue-grey darken-4 mdb-color white-text">
            ...
            <th class="text-center">Add a Note</th>
